...
- **Version:** 1.9.3
- **Usage:** Loaded via CDN for video processing and canvas rendering
...
- **Version:** 0.12.2
- **Usage:** Loaded via CDN for AI/ML object detection and pose estimation
...
- **Version:** 3.10.1
- **Usage:** npm package for creating ZIP archives of PNG sequences
...
- **Usage:** Web font for UI typography
...
All licenses used in this project are compatible with the MIT license chosen for this project:
- **MIT** - Fully compatible
- **Apache 2.0** - Compatible with MIT
- **LGPL 2.1** - Compatible when used as a library (p5.js is loaded separately)
- **SIL OFL 1.1** - Font license, separate from code license
